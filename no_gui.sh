...
ffmpeg -i $1 -f yuv4mpegpipe - | $rootdir/frame_remover/frame_remover $1_rm.txt 48000 | $rootdir/prepend_frame/prepend_frame `basename $1 .mp4`.png 9188 | yuvview | avconv -f yuv4mpegpipe -i - -b 10000k -threads 8 `basename $1 .mp4`_noaudio.mp4
mv $1.s16l $1.raw
...
ffmpeg -i `basename $1 .mp4`_noaudio.mp4 -f s16le -ac 1 -ar 48000 -i $1_jg_bg.raw -map 0:0 -map 1:0 -vcodec copy -ab 64k `basename $1 .mp4`_mix.mp4
